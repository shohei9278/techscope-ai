...
export default function ArticleCard({ article }: Props) {
  return (
    <Link
      href={`/article/${article.article_id ? article.article_id : article.id}`}
    ...
    >
       <div className="flex flex-wrap gap-2 mb-3">
        <span
          className={`px-2 py-1 text-xs bg-zinc-100 dark:bg-zinc-800 rounded-md ${article.isRead ? "bg-green-100 dark:bg-green-800 text-green-800 dark:text-green-200" : "bg-red-100 dark:bg-red-800 text-red-800 dark:text-red-200"}`}
          >
